...
public class ItemService {
    ...
    public ItemDto addNewItem(Long ownerId, ItemDto newItemDto) {
        userValidator.checkUserOnExistence(ownerId);
    ...
    public ItemDto updateItem(Long userId, ItemDto itemToUpdate, Long itemId) {
        userValidator.checkUserOnExistence(userId);
        ...
        if (itemToUpdate.getName() != null) updatingItem.setName(itemToUpdate.getName());
        if (itemToUpdate.getDescription() != null) updatingItem.setDescription(itemToUpdate.getDescription());
        if (itemToUpdate.getAvailable() != null) updatingItem.setAvailable(itemToUpdate.getAvailable());
